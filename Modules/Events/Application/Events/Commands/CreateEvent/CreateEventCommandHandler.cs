...
// Injecting the interface EventsDbContext instead of AppDBContext 
    ...
    IOrganizationAuthorizationService authorizationService) : IRequestHandler<CreateEventCommand, Guid>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        // ── 2. RBAC: caller must be an active member with events.create ────────
        ...
        // This also implicitly verifies that the organization exists.
