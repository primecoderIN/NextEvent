...
public class DatabaseInitializer
{
    public static async Task SeedData(
        ...
        OrganizationsDbContext orgContext,
        ...
        UserManager<User> userManager)
    {
        ...
        eventsContext.Events.AddRange(events); //Tracking events inside the memory
        await eventsContext.SaveChangesAsync(); //Saving the changes in the database
    }
}
