...
/**
 * Reusable error UI component used by both React error boundary and global error handlers
 */
export function ErrorUI({ 
  title = "Unexpected Application Error",
  message = "Something went wrong. You can try refreshing the page.",
  errorDetails 
}: ErrorUIProps) {
  return (
...
/**
 * React Error Boundary component - catches render and lifecycle errors
 */
export function GlobalErrorBoundary() {
  ...
  return (
    <ErrorUI 
      title={isChunkError ? "App Update Available" : "Unexpected Application Error"}
